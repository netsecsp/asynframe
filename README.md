## Asynframe framework v1.4.4 [english](/README_EN.md) | 中文
...
# 变更记录
> 2023/03/18 发布windows平台的asynframe framework v1.4.4  
1. 发布插件: dtp/ras  
...
# 编译环境
> sdk_v1.4.4-Msvc2019_20230318.zip是通过Microsoft Visual Studio 2019编译的SDK  
> sdk_v1.4.4-Msvc2013_20230318.zip是通过Microsoft Visual Studio 2013编译的SDK  
