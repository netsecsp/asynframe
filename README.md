## Asynframe framework v1.3.2 [english](/README_EN.md) | 中文
...
# 变更记录
> 2023/01/30 发布windows平台的asynframe framework v1.3.2  
...
# 编译环境
> sdk_v1.3.2-Msvc2019_20230130.zip是通过Microsoft Visual Studio 2019编译的SDK  
> sdk_v1.3.2-Msvc2013_20230130.zip是通过Microsoft Visual Studio 2013编译的SDK  
